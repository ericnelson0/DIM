(function() {
  ...
  function StoreService($rootScope, $q, bungieService, settings, platformService, itemTiers, categories, itemDefs, itemBucketDefs, objectiveDefs, talentDefs, sandboxPerkDefs, statDefs, yearsDefinitions) {
    var _stores = [];
    ...
    function getItems(owner, items, definitions) {
      ...
      var promise = itemDefs.getDefinitions()
        ...
        .then(yearsDefinitions.getDefinitions)
        .then(function(defs) {
          iteratorPB = iteratorPB.bind(null, defs);
